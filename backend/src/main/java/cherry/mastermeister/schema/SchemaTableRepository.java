...
public interface SchemaTableRepository extends JpaRepository<SchemaTable, Long> {
    ...
    Optional<SchemaTable> findByConnectionIdAndSchemaNameAndTableName(
            Long connectionId, String schemaName, String tableName);

    Optional<SchemaTable> findByConnectionIdAndSchemaNameAndTableNameAndStaleFalse(
            Long connectionId, String schemaName, String tableName);

    List<SchemaTable> findByConnectionId(Long connectionId);

    List<SchemaTable> findByConnectionIdAndStaleFalse(Long connectionId);
