...
public interface AuxPermissionAssignmentRepository extends JpaRepository<AuxPermissionAssignment, Long> {

    Optional<AuxPermissionAssignment> findByPrincipalTypeAndPrincipalIdAndConnectionIdAndSchemaNameAndTableNameAndAuxType(
