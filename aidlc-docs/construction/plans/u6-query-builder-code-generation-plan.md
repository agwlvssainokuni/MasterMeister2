...
### Step 5: APIレイヤ生成
- [ ] 5-1. `backend/src/main/java/cherry/mastermeister/querybuilder/SqlParseRequest.java`
...
### Step 7: APIレイヤサマリ
- [ ] 7-1. `aidlc-docs/construction/u6-query-builder/code/api-layer-summary.md`を生成し、
...
- [ ] 11-7. `frontend/src/features/queryBuilder/SqlReverseParsePanel.tsx`: 手入力SQL貼り付け→
