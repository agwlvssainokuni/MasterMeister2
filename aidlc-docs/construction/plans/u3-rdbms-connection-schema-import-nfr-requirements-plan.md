...
- [ ] `aidlc-docs/construction/u3-rdbms-connection-schema-import/nfr-requirements/nfr-requirements.md`
- [ ] `aidlc-docs/construction/u3-rdbms-connection-schema-import/nfr-requirements/tech-stack-decisions.md`
...
A. 接続タイムアウトを5秒に設定する（HikariCPの`connectionTimeout`、および`testConnection`の
   ...
   避ける（推奨。U1のメール送信タイムアウト方針〈5秒程度〉と一貫する）
