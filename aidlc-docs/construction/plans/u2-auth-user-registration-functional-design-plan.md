...
- [x] `aidlc-docs/construction/u2-auth-user-registration/functional-design/domain-entities.md`
- [x] `aidlc-docs/construction/u2-auth-user-registration/functional-design/business-rules.md`
- [x] `aidlc-docs/construction/u2-auth-user-registration/functional-design/business-logic-model.md`
  （PBT-01: テスト可能な性質セクションを含む）
- [x] `aidlc-docs/construction/u2-auth-user-registration/functional-design/frontend-components.md`